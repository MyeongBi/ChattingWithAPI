...
import com.example.chattingwithapi.databinding.ListTalkItemMineBinding
import com.example.chattingwithapi.databinding.ListTalkItemOthersBinding
...
class RecyclerMessagesAdapter(
            ...
            .addValueEventListener(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for (data in snapshot.children) {
                        messages.add(data.getValue(Message::class.java) as Message)         //메시지 목록에 추가
    ...
    inner class OtherMessageViewHolder(itemView: ListTalkItemOthersBinding) :         //상대 메시지 뷰홀더
        ...
        fun bind(position: Int) {           //메시지 UI 항목 초기화
            ...
            Log.i("txtMessage.text", message.content)
